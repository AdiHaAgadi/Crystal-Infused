...
public class ModBlocks {
    ...
    public static final Block SAPPHIRE_ORE = registerBlock("sapphire_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7), FabricBlockSettings.copyOf(Blocks.STONE).strength(3.0f).requiresTool()));
    ...
    public static final Block SUGILITE_ORE = registerBlock("sugilite_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7), FabricBlockSettings.copyOf(Blocks.NETHERRACK).strength(3.0f).requiresTool()));
    public static final Block SPINEL_ORE = registerBlock("spinel_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7), FabricBlockSettings.copyOf(Blocks.END_STONE).strength(3.0f, 9.0f).requiresTool()));
    public static final Block PEARL_ORE = registerBlock("pearl_ore",
            new ExperienceDroppingFallingBlock(new ColorCode(14406560), UniformIntProvider.create(3, 7), FabricBlockSettings.copyOf(Blocks.SAND).mapColor(MapColor.PALE_YELLOW).strength(1.0f).requiresTool().sounds(BlockSoundGroup.SAND)));
