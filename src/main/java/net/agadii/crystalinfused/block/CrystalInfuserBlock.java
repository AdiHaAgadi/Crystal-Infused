...
public class CrystalInfuserBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof CrystalInfuserBlockEntity) {
                ItemScatterer.spawn(world, pos, (CrystalInfuserBlockEntity)blockEntity);
