...
public class CrystalPurificationRecipe implements Recipe<SimpleInventory> {
    ...
    public CrystalPurificationRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<CrystalPurificationRecipe> {
        ...
        public CrystalPurificationRecipe read(Identifier id, JsonObject json) {
            ...
            return new CrystalPurificationRecipe(id, output, inputs);
        }

        @Override
        public CrystalPurificationRecipe read(Identifier id, PacketByteBuf buf) {
